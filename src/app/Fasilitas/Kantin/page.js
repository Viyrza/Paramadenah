  ...
  return (
    <div className="relative bg-background_secondary overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 py-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">Kantin</h1>
        <p className="text-center font-semibold text-black mt-2">
          Kantin sementara di Universitas Paramadina menyediakan berbagai
          pilihan makanan dan minuman untuk memenuhi kebutuhan makan civitas
          akademika. Meskipun sifatnya sementara, kantin ini tetap memberikan
          kenyamanan dengan pilihan yang praktis dan harga terjangkau.
        </p>
