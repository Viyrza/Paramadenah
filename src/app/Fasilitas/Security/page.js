    ...
    <div className="relative bg-background_secondary overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 py-4">
        ...
        <p className="text-center font-semibold text-black mt-2">
          Security spot di Universitas Paramadina berada di area strategis dekat
          pintu masuk lift yang berada di gedung A. Pos ini dirancang sederhana
          namun fungsional, dilengkapi meja, kursi.
        </p>
