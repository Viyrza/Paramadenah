...
import KelasD21 from '@/png/D21.svg'; // Gambar kelas utama
import LorongD21 from '@/png/lorongd21.svg'; // Gambar koridor
...
import DenahD21 from '@/png/denahd21.svg';
  ...
  return (
    <div className="relative bg-background_secondary overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 py-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">D2-1</h1>
        <p className="text-center text-gray-700 mt-2">
          Kelas D2-1 ini dilengkapi dengan fasilitas sebagai berikut:
        </p>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-black font-semibold text-sm">= 40 meja gambar</p>
          </div>
        </div>
      </div>
