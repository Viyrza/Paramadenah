...
import DenahD23 from '@/png/DenahD23.png';
  ...
  return (
    <div className="relative bg-background_secondary overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 py-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">D2-3</h1>
        <p className="text-center text-gray-700 mt-2">
          Kelas D2-3 ini dilengkapi dengan fasilitas sebagai berikut:
        </p>
