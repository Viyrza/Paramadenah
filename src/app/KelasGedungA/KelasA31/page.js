...
import DenahA31 from '@/png/DenahA31.png';
  ...
  return (
    <div className="relative bg-background_secondary overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 py-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">A3-1</h1>
        <p className="text-center semi font-semibold text-black mt-2">
          Kelas A3-1 ini dilengkapi dengan fasilitas sebagai berikut:
        </p>
