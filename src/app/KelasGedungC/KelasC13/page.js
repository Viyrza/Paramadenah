...
import Denahc13 from '@/png/Denahc13.png';
  ...
  return (
    <div className="relative bg-background_secondary overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 py-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">C1-3</h1>
        <p className="text-center semi font-semibold text-black mt-2">
          Kelas C1-3 ini dilengkapi dengan fasilitas sebagai berikut:
        </p>
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          <div className="flex items-center gap-2">
            ...
            <p className="text-black font-semibold text-sm">= 30 orang</p>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-black font-semibold text-sm">= 1 papan tulis</p>
          </div>
