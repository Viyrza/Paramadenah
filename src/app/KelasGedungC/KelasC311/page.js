...
import DenahC35 from '@/png/DenahC35.png';
  ...
  return (
    <div className="relative bg-background_secondary overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 py-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">C3-11</h1>
        <p className="text-center semi font-semibold text-black mt-2">
          Kelas C3-11 ini dilengkapi dengan fasilitas sebagai berikut:
        </p>
